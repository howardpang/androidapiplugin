...
名称 | ID | 类
----|----|----
工程配置插件 | **com.yy.android.small** | _net.wequick.gradle.**RootPlugin**_
宿主配置插件 | **com.yy.android.small.host** | _net.wequick.gradle.**HostPlugin**_
App组件打包插件 | **com.yy.android.small.application** | _net.wequick.gradle.**AppPlugin**_
Library组件打包插件 | **com.yy.android.small.library** | _net.wequick.gradle.**LibraryPlugin**_
资源组件打包插件 | **com.yy.android.small.asset** | _net.wequick.gradle.**AssetPlugin**_
...
当在Root的build.gradle中配置`aply plugin 'com.yy.android.small`时，将会遍历其所有的子模块(subprojects)：
